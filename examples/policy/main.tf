...
module "schematics_agent" {
  ...
  agent_policy_name              = "${var.prefix}-agent-policy"
  agent_policy_description       = "${var.prefix}-agent-policy-description"
  agent_policy_resource_group_id = module.resource_group.resource_group_id
}
