...
[![Terraform Registry](https://img.shields.io/badge/terraform-registry-623CE4?logo=terraform)](https://registry.terraform.io/modules/terraform-ibm-modules/schematics-agent/ibm/latest)
...
## Overview
<ul>
  <li><a href="#terraform-ibm-schematics-agent">terraform-ibm-schematics-agent</a></li>
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-schematics-agent/tree/main/modules">Submodules</a>
    <ul>
      <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-schematics-agent/tree/main/modules/schematics-policy">schematics-policy</a></li>
    </ul>
  </li>
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-schematics-agent/tree/main/examples">Examples</a>
    <ul>
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-schematics-agent/tree/main/examples/kubernetes">Kubernetes example</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-schematics-agent/tree/main/examples/openshift">OpenShift example</a>
